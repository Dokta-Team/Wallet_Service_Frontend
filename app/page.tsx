...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col">
      <div
        className="w-full h-[100vh] pt-10 bg-fixed bg-top"
        style={{
          backgroundImage:
            "linear-gradient(to right bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/dokta-banner.jpeg)",
        }}
      >
        <div className="w-1/2 h-full flex flex-col justify-center pl-10 text-white gap-10">
        ...
        <div className="w-[70%] h-fit p-5 rounded-lg bg-white absolute left-[50%] bottom-[-55%] translate-x-[-50%] translate-y-[-50%] drop-shadow-md">
          <div className="w-full h-auto flex items-center gap-5 mb-10">
            ...
            <Button variant="default" size="sm" className="bg-[#2A3780]">
              {" "}
        ...
        <div className="w-full h-auto pt-64">
          <div className="w-full h-[100vh] flex items-center">
            <div className="w-1/2 h-full flex flex-col justify-center pl-10">
              <h2 className="text-5xl leading-[1.3] font-semibold mb-10">
                {" "}
